...
const generateMockMoodData = () => {
  const moods = ['Happy', 'Calm', 'Excited', 'Grateful', 'Thoughtful', 'Sad', 'Anxious', 'Tired'];
  const last30Days = [];
  for (let i = 29; i >= 0; i--) {
    const date = new Date();
...
export default function AnalyticsPage() {
  ...
  const loadAnalytics = useCallback(async () => {
    ...
    const avgEnergy = mockData.reduce((sum, d) => sum + d.energy, 0) / totalMoods;
    const totalGoalsCompleted = mockData.reduce((sum, d) => sum + d.goals_completed, 0);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 soft-glow text-center">
            <div className="text-2xl font-bold text-green-600 mb-1">{stats.completedGoals}</div>
            <div className="text-sm text-gray-600">Goals Completed</div>
          </div>
          
          <div className="bg-white rounded-xl p-6 soft-glow text-center">
            <div className="text-2xl font-bold text-purple-600 mb-1">{stats.journalEntries}</div>
            <div className="text-sm text-gray-600">Journal Entries</div>
          </div>
          
          <div className="bg-white rounded-xl p-6 soft-glow text-center">
            <div className="text-2xl font-bold text-yellow-600 mb-1">{stats.avgMoodScore}%</div>
            <div className="text-sm text-gray-600">Positive Days</div>
          </div>
          
          <div className="bg-white rounded-xl p-6 soft-glow text-center">
            <div className="text-2xl font-bold text-orange-600 mb-1">{stats.avgEnergyLevel}/5</div>
            <div className="text-sm text-gray-600">Avg Energy</div>
          </div>
          
          <div className="bg-white rounded-xl p-6 soft-glow text-center">
            <div className="text-xl font-bold text-pink-600 mb-1">{topMood?.[0] || 'N/A'}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-xl p-8 soft-glow">
            <h2 className="text-xl font-bold text-gray-900 mb-6">📈 Mood Timeline</h2>
            <div className="space-y-3">
              {moodData.slice(-10).map((day, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  ...
                  <div className="text-sm font-medium text-gray-700 w-20">{day.mood}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-8 soft-glow">
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h3 className="font-semibold text-green-800 mb-2">🎉 Great Progress!</h3>
                <p className="text-green-700 text-sm">
                  You've maintained a {stats.currentStreak}-day streak and completed {stats.completedGoals} goals this period.
                </p>
              </div>
              
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 className="font-semibold text-blue-800 mb-2">📊 Pattern Notice</h3>
                <p className="text-blue-700 text-sm">
                  Your most frequent mood is {topMood?.[0]} with {stats.avgEnergyLevel}/5 average energy.
                </p>
              </div>
              
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <h3 className="font-semibold text-purple-800 mb-2">✨ Wellness Score</h3>
                <p className="text-purple-700 text-sm">
                  {stats.avgMoodScore}% of your days have been positive. Keep up the great work!
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Consider setting a consistent morning routine to boost energy levels.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Try writing in your journal daily to improve mood awareness.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Engage with the community for additional support and motivation.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Mix different types of goals to maintain engagement and growth.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-linear-to-r from-blue-50 to-purple-50 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-700 mb-4 max-w-2xl mx-auto">
            ...
            and personalized insights based on your unique wellness journey.
          </p>
          <p className="text-sm text-gray-600">
            Current data shown is representative. Full analytics integration is in progress.
          </p>
        </div>
      </main>
    </div>
