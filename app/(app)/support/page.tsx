    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[var(--feelup-muted)] max-w-3xl mx-auto">
          ...
          <motion.div variants={stagger} className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <motion.section
                ...
                className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-8 shadow-[var(--card-shadow)]"
              >
                <h2 className="text-2xl font-bold text-[var(--foreground)] mb-6">
                  Quick Help
                </h2>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 border border-[var(--card-border)] rounded-xl hover:bg-[var(--input-bg)] cursor-pointer">
                    <h3 className="font-semibold text-[var(--brand-blue)] mb-2">
                      Getting Started
                    </h3>
                    <p className="text-[var(--feelup-muted)] text-sm">
              ...
              >
                ...
                {submitted ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-[var(--feelup-muted)] mb-4">
                      Thank you for reaching out. We'll get back to you within
                      24 hours.
                    </p>
                    <button
                      onClick={() => setSubmitted(false)}
                      className="text-[var(--brand-blue)] hover:opacity-80 font-medium"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-sm font-medium text-[var(--feelup-muted)] mb-1"
                      >
                        Name
                      </label>
                      <input
        ...
        {/* Navigation */}
        <motion.div variants={cardIn} className="text-center mt-12">
          <button
            onClick={() => router.push("/mood-feed")}
            className="inline-flex items-center text-[var(--brand-blue)] hover:opacity-80 font-medium"
          >
            ← Back to Home
          </button>
        </motion.div>
