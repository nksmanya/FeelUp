...
const mockEvents: Event[] = [
  {
    ...
    description: 'Start your day with clarity and intention. Join us for a guided meditation session focusing on breath awareness and setting positive intentions for the day ahead.',
    category: 'wellness',
    date: '2025-12-03',
    time: '07:00',
    duration: '45 min',
  ...
  },
  {
    ...
    description: 'Collaborative study session for Psychology 301. We\'ll review cognitive behavioral therapy concepts and prepare for the upcoming midterm exam.',
    category: 'study',
    date: '2025-12-03',
    time: '14:00',
    duration: '2 hours',
  ...
  },
  {
    ...
    description: 'Casual virtual meetup for students to connect, share experiences, and support each other. Bring your favorite beverage and join the conversation!',
    category: 'social',
    date: '2025-12-03',
    time: '19:00',
    duration: '1 hour',
  ...
  },
  {
    ...
    description: 'High-intensity interval training session designed to boost your energy and fitness levels. All fitness levels welcome with modifications available.',
    category: 'fitness',
    date: '2025-12-04',
    time: '18:00',
    duration: '1 hour',
  ...
  },
  {
    ...
    description: 'Learn practical techniques for managing academic and life stress. Topics include time management, relaxation techniques, and building resilience.',
    category: 'wellness',
    date: '2025-12-05',
    time: '16:00',
    duration: '1.5 hours',
  ...
  },
  {
    ...
    description: 'Explore local trails and connect with nature. A moderate 5-mile hike with beautiful scenic views. Perfect for clearing your mind and getting active!',
    category: 'fitness',
    date: '2025-12-07',
    time: '09:00',
    duration: '4 hours',
...
export default function EventsPage() {
  ...
  const categories = [
    ...
    { id: 'wellness', label: 'Wellness', icon: '🧘', count: events.filter(e => e.category === 'wellness').length },
    { id: 'study', label: 'Study Groups', icon: '📚', count: events.filter(e => e.category === 'study').length },
    { id: 'social', label: 'Social', icon: '🎉', count: events.filter(e => e.category === 'social').length },
    { id: 'fitness', label: 'Fitness', icon: '💪', count: events.filter(e => e.category === 'fitness').length }
  ];
      ...
      event.id === eventId 
        ? { 
            ...
            attendees: status === 'going' 
              ? (event.rsvpStatus === 'going' ? event.attendees : event.attendees + 1)
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-6 max-w-3xl mx-auto">
            Join wellness activities, study sessions, and community meetups to enhance your well-being and connect with others
          </p>
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  {event.price !== undefined && (
                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                      event.price === 0 ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
                    }`}>
        ...
        {!session && (
          <div className="bg-linear-to-r from-purple-100 to-pink-100 rounded-xl p-8 text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Want to Create Your Own Event?</h2>
            <p className="text-gray-700 mb-6">
              Sign in to create and organize events for the community. Share your expertise and bring people together!
            </p>
            <button 
              onClick={() => router.push('/login')}
