...
export default function StreakDisplay({ userEmail, streakType, size = 'medium' }: StreakDisplayProps) {
  ...
  const loadStreak = async () => {
    ...
    try {
      ...
      if (res.ok) {
        const typeStreak = data.streaks?.find((s: any) => s.streak_type === streakType);
